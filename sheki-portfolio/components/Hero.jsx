        ...
        <div className='h-screen w-screen heropic flex items-center mb-0 bg-fixed bg-cover '>
            <div className='text-white flex flex-col absolute inset-y-1/4 pl-14 pr-14'>
                ...
                <div className='flex flex-row justify-between'>
                    {/* Button 1 */}
                    <button className='border-4 rounded-lg hover:bg-purple border-purple mr-4 p-3 font-bold text-s md:text-m'>
                        Get A Quote
                    </button>

                    {/* Button 2 */}
                    <button className='text-lpurple font-bold text-s md:text-m hover:border-purple hover:rounded-lg hover:p-3 hover:bg-white'>
                        Email Me
                    </button>
                </div>
            </div>
